...
import 'package:shop_bee/page/SingleProductPage.dart';
  ...
  class _MallPageState extends State<BrandPage> {
    ...
    Widget build(BuildContext context) {
      ...
      List<String> listBarndName = ['Innisfree','2q','Somthing3','Somthing4',
        'Somthing5','Somthing6','Somthing7','Somthing8','Somthing9','Somthing10'];
      return Scaffold(
              ...
              ListTile(
                title: Column(
                  children: [
                    ...
                    Text('Thương hiệu nổi bật',style: GoogleFonts.nunito(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                                ...
                                child: SingleChildScrollView(
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>SingleBarndPage()));
                                    },
                                    child: Column(
                                      children: [
                                        Container(
                                        ...
                                        Text(
                                          ...
                                          style: GoogleFonts.nunito(
                                            textStyle: TextStyle(color: Color(0xFFFF7F50),fontSize: 18,fontWeight: FontWeight.w700),
                                          ),
                                        ),
                                      ],
                                    ),
                            ...
                            Container(height: 1,color: Colors.grey,margin: EdgeInsets.all(5),),
                            Expanded(
                              child: Container(
